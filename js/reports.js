...
/* Leads with the logo's two brand colours — blue wordmark, then the flame
   orange and tagline gold — before falling back to supporting hues. */
const CHART_COLORS = [
  '#0a55d8',
  '#f97b0d',
  '#fdb801',
...
function downloadPdf() {
  ...
  doc.text(`PK Galla — ${MODE_LABELS[mode]} report`, margin, y);
  y += 22;
  ...
  doc.text(
    `Generated by PK Galla on ${new Date().toLocaleDateString('en-PK')}`,
    margin,
